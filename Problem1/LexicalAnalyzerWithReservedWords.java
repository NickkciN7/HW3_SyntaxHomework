...
public class LexicalAnalyzerWithReservedWords {
	/* Global declarations */
	/* Variables */
...
//		}
		...
		try {
			fin = new FileInputStream("TEST_Problem1.txt"); //TEST.txt needs to be in outer workspace folder, not in src with Java file
